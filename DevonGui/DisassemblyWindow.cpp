...
void DisassemblyWindow::DrawWindow(const char* title, DevonMMU & MMU, Devon::CPU & CPU, uLONG base_display_addr/* = 0x0000*/)
{
...
int DisassemblyWindow::DisassembleInstruction(std::string & out, uLONG addr, DevonMMU & MMU)
{
